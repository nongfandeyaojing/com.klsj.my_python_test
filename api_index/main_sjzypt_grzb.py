'''
功能：海口城市大脑项目-数据资源平台板块-个人周报【自动化】
0.手动更新/任务更新 rds中表xxx中的数据
1.读取dataworksxxx表中的指标数据
2.创建【海口城市大脑项目-数据资源平台板块-个人周报模板.docx】模板文件
3.将应用模板文件，生成新word,excel
4.将word转html.
5.发送邮件
6.钉钉就不用了吧。--
7.日志
...
if __name__ == "__main__":
    ...
    # 文件路径
    report_name = '海口城市大脑项目-数据资源平台版块-个人周报'
    templa_doc_file = report_name + '模板.docx'  #模板路径
    ...
    d_t_e.send_Email(sender=sender,
                     subject='【自动化】'+report_name+'【测试】'+time.strftime("%Y-%m-%d", time.localtime()),
                     context_html=html,
